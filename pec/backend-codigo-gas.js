...
function doPost(e) {
  try {
    ...
    if (['encuestaAlumno','encuestaPadre','adminPortal','saveIncidencia','marcarLaborSocial','saveMensaje','toggleMensaje','deleteMensaje','saveCumpleanos','toggleCumpleanos','deleteCumpleanos'].includes(action)) {
