    ...
    if(btnSubmit) {
        btnSubmit.onclick = async () => {
            ...
            try {
                ...
                const response = await fetch(api.GOOGLE_SHEETS_API_URL || "https://script.google.com/macros/s/AKfycbwqT7gO_vF_V20F0kFvQdIwQslBuLqc5_wVtiNU_lfsDN5l3kMp3AV1uN9423eG0TyLNw/exec", {
                    method: 'POST',
                    mode: 'no-cors', 
