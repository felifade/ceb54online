// Service Worker — Docente 2.0 CEB 5/4
...
const CACHE = 'docente2-v1';
const STATIC = [
  '/docente2/',
  '/docente2/index.html',
  '/docente2/manifest.json',
  '/docente2/css/style.css',
  '/docente2/css/horario.css',
];
...
self.addEventListener('fetch', e => {
  ...
  // Solo manejar rutas del portal docente2
  if (!url.pathname.startsWith('/docente2/')) return;

  // Para JS y CSS: network-first (siempre código fresco, fallback a caché)
